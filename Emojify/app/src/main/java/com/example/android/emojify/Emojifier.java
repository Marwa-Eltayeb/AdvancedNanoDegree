...
class Emojifier {
    ...
    private static Emoji whichEmoji(Face face) {
        ...
        Timber.d(LOG_TAG, "whichEmoji: leftEyeOpenProb = " + face.getIsLeftEyeOpenProbability());
        Timber.d(LOG_TAG, "whichEmoji: rightEyeOpenProb = " + face.getIsRightEyeOpenProbability());
